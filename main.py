...
Original file is located at
    https://colab.research.google.com/drive/1uC-tKdALEsGVeylvuE-aCsl1b0XdPUVP
"""
...
while not input_valid and i in range(5):
  ...
  try:
    ...
    if int(combat_strength) not in range(1,7):
      print("Enter a valid in between 1 and 6 ")
      i = i+1
...
while not input_valid and i in range(5):
    ...
    # Lab 9 - Let’s the program know you’re potentially expecting an error
  try:
    m_combat_strength = int(input("Enter your combat Strength (1-6): "))
    ...
    # Lab 9 - If the error occurs, make sure to add your own custom message instead of letting the program crash with a red error
      ...
      print("Exception: Invalid input. Player needs to enter integer numbers for monster combat strength")
...
while m_health_points > 0 and health_points > 0:
    ...
    if not (attack_roll % 2 == 0):
        ...
        try:
            ...
            m_health_points = function.hero_attacks("Somestring1", "Somestring2")
            health_points =  function.monster_attacks("new", "game")
              # Debug statement for
